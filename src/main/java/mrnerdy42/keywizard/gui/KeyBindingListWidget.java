...
import mrnerdy42.keywizard.gui.TestScrollingListWidget.LanguageEntry;
...
public class KeyBindingListWidget extends EntryListWidget<KeyBindingListWidget.BindingEntry> {
	...
	protected void renderList(MatrixStack matrices, int x, int y, int mouseX, int mouseY, float delta) {
		//RenderSystem.enableScissor(this.left, this.top, this.width, this.height);
		...
		for (int j = 0; j < i; ++j) {
			...
			r = this.getRowLeft();
			entry.render(matrices, j, k, r, o, n, mouseX, mouseY,
					this.isMouseOver((double) mouseX, (double) mouseY)
